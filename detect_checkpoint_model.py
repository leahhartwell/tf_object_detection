...
parser.add_argument("-i", "--input", help = "Path to Input Folder, Format: sting, Default: test", required = False, default = "test", type = str)
...
detect_fn, category_index = lod.load_checkpoint(args.model,args.label_map)
...
if args.input_type == "i":
    ...
    for image in range(len(IMAGE_PATHS)-1):
        ...
        image_tensor = lod.process_image_checkpoint(image_np)
